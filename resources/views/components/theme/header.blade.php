<!doctype html>
<html lang="en" @foreach (session('theme_settings', []) as $key => $value) {{ $key }}="{{ $value }}" @endforeach>


<head>
    <meta charset="utf-8" />
    <title>@yield('title', ucwords(str_replace('-', ' ', Request::path()))) | @common('project_name')</title>
